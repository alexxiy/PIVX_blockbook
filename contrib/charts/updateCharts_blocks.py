...
rpc_pass = "password"
rpc_host = "127.0.0.1"
rpc_port = "51475" if isTestnet else "51473"
rpc_url = "http://%s:%s@%s" % (rpc_user, rpc_pass, rpc_host)
#bb_url = "https://testnet" if isTestnet else "https://explorer"
#bb_url += ".blackhatco.in"
bb_url = "http://127.0.0.1:9130"

# FILENAME
supply_data_file = os.path.join("./plot_data", "supply_data.json")
network_data_file = os.path.join("./plot_data", "network_data.json")
